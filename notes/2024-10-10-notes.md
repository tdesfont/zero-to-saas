...
Task (many-to-many with Tag, one-to-many with Event, one-to-many with Notification):
- Prendre une heure pour reflechir sur les impots
- Mise en place du compte sur Bourse Directe
- Prepare the meeting with Albert
- Lire les offres d'annonce sur ML Engineer
- Construire un bureau a la Trinite